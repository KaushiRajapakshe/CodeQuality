...
<nav>
    <div class="nav-wrapper navbar-size">
        <ul>
            <a href="#" class="brand-logo"><img class="user-image-size" src="images/logo.png"></a>
...
<h1 style="color: black">Code Complexity</h1>
</br>
<div id="dis"></div>
<table id="example" class="table table-bordered table-hover" style="width:100%">
    ...
    <tr >
        <td width="3%">Line no</td>
        <td width="46%">Total Code Complexity Count</td>
        <td width="30%"></td>
        <td width="3%">Cs</td>
        <td width="3%">Ctc</td>
        <td width="3%">Cnc</td>
    ...
    <br/>
    <div align="left" width="100%" color="black">
        <label style="color: #0c0c0c" for="fileUploader">File Name:</label>
        <input type="file" name="file" size="50" id="fileUploader" class="btn"/>
    </div>
    <div class="footer">
        <div class="text">Copyright ©2024 All rights reserved | The Code Complexity Measuring Tool owned  by Straight Aces</div>
    </div>
